...
var _dotsJs = require("/Classes/Dots.js");
var _konvaUIJs = require("/Classes/KonvaUI.js");
...
//Main function
function main() {
    let konva = new (0, _konvaUIJs.KonvaUI)();
    let dots = new (0, _dotsJs.Dots)();
    initialize(dots);
...
},{"/Classes/Dots.js":"ebK5p","/Classes/KonvaUI.js":"ayC8u"}],"ebK5p":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
//Class that holds a collection of dots
parcelHelpers.export(exports, "Dots", ()=>Dots);
var _dotJs = require("/Classes/Dot.js");
class Dots {
    constructor(){
        this.dots = [];
    }
    ...
    addDot(x, y, radius, color) {
        let dot = new (0, _dotJs.Dot)(x, y, radius, color);
        this.dots.push(dot);
        return dot;
    }
    getAllDots() {
...
},{"/Classes/Dot.js":"4yeXm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4yeXm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
//An individual dot
parcelHelpers.export(exports, "Dot", ()=>Dot);
var _commentaryJs = require("/Classes/Commentary.js");
class Dot {
    ...
    addCommentary(text, color) {
        let commentary = new (0, _commentaryJs.Commentary)(text, color);
        this.commentaries.push(commentary);
        return commentary;
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","/Classes/Commentary.js":"8U5jJ"}],"gkKU3":[function(require,module,exports) {
...
},{}],"8U5jJ":[function(require,module,exports) {
//An individual commentary
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Commentary", ()=>Commentary);
class Commentary {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ayC8u":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
//Model-view to Konva
parcelHelpers.export(exports, "KonvaUI", ()=>KonvaUI);
...
class KonvaUI {
    ...
    layer;
    constructor(){
        this.stage = new (0, _konvaDefault.default).Stage({
            container: "container",
            width: window.innerWidth,
            height: window.innerHeight
        });
        this.layer = new (0, _konvaDefault.default).Layer();
        this.stage.add(this.layer);
    }
    //Adds a dot to the layer
    addDotToLayer(dot) {
        let circle = new (0, _konvaDefault.default).Circle({
            x: dot.x,
            y: dot.y,
            radius: dot.radius,
            fill: dot.color
    ...
    #addComments(dot) {
        ...
        dot.commentaries.forEach((commentary)=>{
            let text = new (0, _konvaDefault.default).Text({
                x: dot.x,
                y: dot.y + step,
            ...
            let rectangle = new (0, _konvaDefault.default).Rect({
                x: dot.x,
                y: dot.y + step,
                stroke: "Black",
                strokeWidth: 1,
...
},{"konva":"geBjd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"geBjd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _fullInternalsJs = require("./_FullInternals.js");
exports.default = (0, _fullInternalsJs.Konva);

},{"./_FullInternals.js":"4VutY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4VutY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const Konva = (0, _coreInternalsJs.Konva).Util._assign((0, _coreInternalsJs.Konva), {
    Arc: (0, _arcJs.Arc),
    Arrow: (0, _arrowJs.Arrow),
    Circle: (0, _circleJs.Circle),
    Ellipse: (0, _ellipseJs.Ellipse),
    ...
    Path: (0, _pathJs.Path),
    Rect: (0, _rectJs.Rect),
    RegularPolygon: (0, _regularPolygonJs.RegularPolygon),
    Ring: (0, _ringJs.Ring),
    Sprite: (0, _spriteJs.Sprite),
    Star: (0, _starJs.Star),
    Text: (0, _textJs.Text),
    TextPath: (0, _textPathJs.TextPath),
    Transformer: (0, _transformerJs.Transformer),
    Wedge: (0, _wedgeJs.Wedge),
    Filters: {
        Blur: (0, _blurJs.Blur),
        Brighten: (0, _brightenJs.Brighten),
        Contrast: (0, _contrastJs.Contrast),
        Emboss: (0, _embossJs.Emboss),
        Enhance: (0, _enhanceJs.Enhance),
        Grayscale: (0, _grayscaleJs.Grayscale),
        HSL: (0, _hslJs.HSL),
        HSV: (0, _hsvJs.HSV),
        Invert: (0, _invertJs.Invert),
        Kaleidoscope: (0, _kaleidoscopeJs.Kaleidoscope),
        Mask: (0, _maskJs.Mask),
        Noise: (0, _noiseJs.Noise),
        Pixelate: (0, _pixelateJs.Pixelate),
        Posterize: (0, _posterizeJs.Posterize),
        RGB: (0, _rgbJs.RGB),
        RGBA: (0, _rgbaJs.RGBA),
        Sepia: (0, _sepiaJs.Sepia),
        Solarize: (0, _solarizeJs.Solarize),
        Threshold: (0, _thresholdJs.Threshold)
    }
});

},{"./_CoreInternals.js":"3dQzw","./shapes/Arc.js":"90zrb","./shapes/Arrow.js":"4hzpq","./shapes/Circle.js":"5FG8s","./shapes/Ellipse.js":"2PVgS","./shapes/Image.js":"8V6x8","./shapes/Label.js":"h6LDn","./shapes/Line.js":"lpEAb","./shapes/Path.js":"jCV6M","./shapes/Rect.js":"27m53","./shapes/RegularPolygon.js":"hYPJG","./shapes/Ring.js":"5Vsc3","./shapes/Sprite.js":"7ZPX9","./shapes/Star.js":"fLcjV","./shapes/Text.js":"i3gDI","./shapes/TextPath.js":"elLOG","./shapes/Transformer.js":"lKbeh","./shapes/Wedge.js":"73XBE","./filters/Blur.js":"9W72y","./filters/Brighten.js":"lAvpJ","./filters/Contrast.js":"8RNiy","./filters/Emboss.js":"6vWw3","./filters/Enhance.js":"7UWph","./filters/Grayscale.js":"bjkFS","./filters/HSL.js":"9ygkl","./filters/HSV.js":"6AhsM","./filters/Invert.js":"4xcg6","./filters/Kaleidoscope.js":"4en15","./filters/Mask.js":"54Bc9","./filters/Noise.js":"a6ed4","./filters/Pixelate.js":"4rWev","./filters/Posterize.js":"kjeD1","./filters/RGB.js":"w7wf7","./filters/RGBA.js":"cxuQv","./filters/Sepia.js":"dNJFy","./filters/Solarize.js":"atrXz","./filters/Threshold.js":"9jS1t","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3dQzw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Konva", ()=>Konva);
...
const Konva = (0, _utilJs.Util)._assign((0, _globalJs.Konva), {
    Util: (0, _utilJs.Util),
    Transform: (0, _utilJs.Transform),
    Node: (0, _nodeJs.Node),
    Container: (0, _containerJs.Container),
    Stage: (0, _stageJs.Stage),
    stages: (0, _stageJs.stages),
    Layer: (0, _layerJs.Layer),
    FastLayer: (0, _fastLayerJs.FastLayer),
    Group: (0, _groupJs.Group),
    DD: (0, _dragAndDropJs.DD),
    Shape: (0, _shapeJs.Shape),
    shapes: (0, _shapeJs.shapes),
    Animation: (0, _animationJs.Animation),
    Tween: (0, _tweenJs.Tween),
    Easings: (0, _tweenJs.Easings),
    Context: (0, _contextJs.Context),
    Canvas: (0, _canvasJs.Canvas)
});
exports.default = Konva;

},{"./Global.js":"asjHM","./Util.js":"a2B39","./Node.js":"bfHol","./Container.js":"5xUok","./Stage.js":"38rm3","./Layer.js":"1Tbuc","./FastLayer.js":"lBeUE","./Group.js":"X8qSb","./DragAndDrop.js":"1gkRd","./Shape.js":"9jDGX","./Animation.js":"2pFne","./Tween.js":"crXwI","./Context.js":"3L4VA","./Canvas.js":"2h78K","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"asjHM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"a2B39":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const Util = {
    ...
    releaseCanvas (...canvases) {
        if (!(0, _globalJs.Konva).releaseCanvasOnDestroy) return;
        canvases.forEach((c)=>{
            c.width = 0;
            c.height = 0;
        });
...
},{"./Global.js":"asjHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bfHol":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Node {
    ...
    clearCache() {
        if (this._cache.has(CANVAS)) {
            ...
            (0, _utilJs.Util).releaseCanvas(scene, filter, hit);
...
},{"./Util.js":"a2B39","./Factory.js":"cBseC","./Canvas.js":"2h78K","./Global.js":"asjHM","./DragAndDrop.js":"1gkRd","./Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cBseC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./Global.js":"asjHM","./Util.js":"a2B39","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2h78K":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function getDevicePixelRatio() {
    ...
    (0, _utilJs.Util).releaseCanvas(canvas);
    return _pixelRatio;
}
class Canvas {
    constructor(config){
...
},{"./Factory.js":"cBseC","./Node.js":"bfHol","./Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"38rm3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Stage extends (0, _containerJs.Container) {
    ...
    destroy() {
        ...
        (0, _utilJs.Util).releaseCanvas(this.bufferCanvas._canvas, this.bufferHitCanvas._canvas);
        return this;
    }
    getPointerPosition() {
...
},{"./Util.js":"a2B39","./Factory.js":"cBseC","./Container.js":"5xUok","./Global.js":"asjHM","./Canvas.js":"2h78K","./DragAndDrop.js":"1gkRd","./PointerEvents.js":"aGqy9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aGqy9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./Global.js":"asjHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1Tbuc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Layer extends (0, _containerJs.Container) {
    ...
    destroy() {
        (0, _utilJs.Util).releaseCanvas(this.getNativeCanvasElement(), this.getHitCanvas()._canvas);
...
},{"./Util.js":"a2B39","./Container.js":"5xUok","./Node.js":"bfHol","./Factory.js":"cBseC","./Canvas.js":"2h78K","./Validators.js":"gkzNd","./Shape.js":"9jDGX","./Global.js":"asjHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9jDGX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./Global.js":"asjHM","./Util.js":"a2B39","./Factory.js":"cBseC","./Node.js":"bfHol","./Validators.js":"gkzNd","./PointerEvents.js":"aGqy9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lBeUE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _layerJs = require("./Layer.js");
var _globalJs = require("./Global.js");
class FastLayer extends (0, _layerJs.Layer) {
    constructor(attrs){
        super(attrs);
        this.listening(false);
        (0, _utilJs.Util).warn('Konva.Fast layer is deprecated. Please use "new Konva.Layer({ listening: false })" instead.');
    }
}
FastLayer.prototype.nodeType = "FastLayer";
(0, _globalJs._registerNode)(FastLayer);

},{"./Util.js":"a2B39","./Layer.js":"1Tbuc","./Global.js":"asjHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"X8qSb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _containerJs = require("./Container.js");
var _globalJs = require("./Global.js");
class Group extends (0, _containerJs.Container) {
    _validateAdd(child) {
        var type = child.getType();
        if (type !== "Group" && type !== "Shape") (0, _utilJs.Util).throw("You may only add groups and shapes to groups.");
    }
}
Group.prototype.nodeType = "Group";
(0, _globalJs._registerNode)(Group);

},{"./Util.js":"a2B39","./Container.js":"5xUok","./Global.js":"asjHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2pFne":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _utilJs = require("./Util.js");
var now = function() {
    if ((0, _globalJs.glob).performance && (0, _globalJs.glob).performance.now) return function() {
        return (0, _globalJs.glob).performance.now();
    };
    return function() {
...
class Animation {
    ...
    static _animationLoop() {
        ...
        if (Anim.animations.length) {
            Anim._runFrames();
            (0, _utilJs.Util).requestAnimFrame(Anim._animationLoop);
        } else Anim.animRunning = false;
    }
    static _handleAnimation() {
        if (!this.animRunning) {
            this.animRunning = true;
            (0, _utilJs.Util).requestAnimFrame(this._animationLoop);
        }
    }
}
...
},{"./Global.js":"asjHM","./Util.js":"a2B39","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"crXwI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Tween {
    constructor(config){
        ...
        this.node = node;
        this._id = idCounter++;
        var layers = node.getLayer() || (node instanceof (0, _globalJs.Konva)["Stage"] ? node.getLayers() : null);
        if (!layers) (0, _utilJs.Util).error("Tween constructor have `node` that is not in a layer. Please add node into layer first.");
        this.anim = new (0, _animationJs.Animation)(function() {
    ...
    _addAttr(key, end) {
        ...
        if ((0, _utilJs.Util)._isArray(end)) {
            diff = [];
            len = Math.max(end.length, start.length);
            if (key === "points" && end.length !== start.length) {
                if (end.length > start.length) {
                    trueStart = start;
                    start = (0, _utilJs.Util)._prepareArrayForTween(start, end, node.closed());
                } else {
                    trueEnd = end;
                    end = (0, _utilJs.Util)._prepareArrayForTween(end, start, node.closed());
                }
            }
            if (key.indexOf("fill") === 0) {
                for(n = 0; n < len; n++)if (n % 2 === 0) diff.push(end[n] - start[n]);
                else {
                    var startRGBA = (0, _utilJs.Util).colorToRGBA(start[n]);
                    endRGBA = (0, _utilJs.Util).colorToRGBA(end[n]);
                    start[n] = startRGBA;
                    diff.push({
            ...
            start = (0, _utilJs.Util).colorToRGBA(start);
            endRGBA = (0, _utilJs.Util).colorToRGBA(end);
            diff = {
                r: endRGBA.r - start.r,
                g: endRGBA.g - start.g,
                b: endRGBA.b - start.b,
    ...
    _tweenFunc(i) {
        ...
        for(key in attrs){
            ...
            if ((0, _utilJs.Util)._isArray(start)) {
                newVal = [];
...
Tween.attrs = {};
Tween.tweens = {};
(0, _nodeJs.Node).prototype.to = function(params) {
...
},{"./Util.js":"a2B39","./Animation.js":"2pFne","./Node.js":"bfHol","./Global.js":"asjHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"90zrb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _globalJs = require("../Global.js");
var _validatorsJs = require("../Validators.js");
class Arc extends (0, _shapeJs.Shape) {
    _sceneFunc(context) {
        var angle = (0, _globalJs.Konva).getAngle(this.angle()), clockwise = this.clockwise();
        context.beginPath();
    ...
    getSelfRect() {
        ...
        const angle = (0, _globalJs.Konva).getAngle(clockwise ? 360 - this.angle() : this.angle());
...
(0, _globalJs._registerNode)(Arc);
(0, _factoryJs.Factory).addGetterSetter(Arc, "innerRadius", 0, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Arc, "outerRadius", 0, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Arc, "angle", 0, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Arc, "clockwise", false, (0, _validatorsJs.getBooleanValidator)());

},{"../Factory.js":"cBseC","../Shape.js":"9jDGX","../Global.js":"asjHM","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4hzpq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Arrow extends (0, _lineJs.Line) {
    _sceneFunc(ctx) {
        ...
        if (fromTension) {
            ...
            const lastLength = (0, _pathJs.Path).calcLength(tp[tp.length - 4], tp[tp.length - 3], "C", lp);
            const previous = (0, _pathJs.Path).getPointOnQuadraticBezier(Math.min(1, 1 - length / lastLength), lp[0], lp[1], lp[2], lp[3], lp[4], lp[5]);
...
(0, _globalJs._registerNode)(Arrow);
(0, _factoryJs.Factory).addGetterSetter(Arrow, "pointerLength", 10, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Arrow, "pointerWidth", 10, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Arrow, "pointerAtBeginning", false);
(0, _factoryJs.Factory).addGetterSetter(Arrow, "pointerAtEnding", true);

},{"../Factory.js":"cBseC","./Line.js":"lpEAb","../Validators.js":"gkzNd","../Global.js":"asjHM","./Path.js":"jCV6M","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lpEAb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../Factory.js":"cBseC","../Shape.js":"9jDGX","../Validators.js":"gkzNd","../Global.js":"asjHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jCV6M":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _shapeJs = require("../Shape.js");
var _globalJs = require("../Global.js");
class Path extends (0, _shapeJs.Shape) {
    constructor(config){
        super(config);
        this.dataArray = [];
        this.pathLength = 0;
        ...
        this.dataArray.forEach(function(data) {
            if (data.command === "A") {
                ...
                if (dTheta < 0) for(let t = start - inc; t > end; t -= inc){
                    ...
                    const point1 = Path.getPointOnEllipticalArc(data.points[0], data.points[1], data.points[2], data.points[3], t1, 0);
                    points.push(point1.x, point1.y);
                }
            } else if (data.command === "C") for(let t2 = 0.0; t2 <= 1; t2 += 0.01){
                const point2 = Path.getPointOnCubicBezier(t2, data.start.x, data.start.y, data.points[0], data.points[1], data.points[2], data.points[3], data.points[4], data.points[5]);
...
(0, _globalJs._registerNode)(Path);
(0, _factoryJs.Factory).addGetterSetter(Path, "data");

},{"../Factory.js":"cBseC","../Shape.js":"9jDGX","../Global.js":"asjHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5FG8s":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _validatorsJs = require("../Validators.js");
var _globalJs = require("../Global.js");
class Circle extends (0, _shapeJs.Shape) {
    _sceneFunc(context) {
        context.beginPath();
...
(0, _globalJs._registerNode)(Circle);
(0, _factoryJs.Factory).addGetterSetter(Circle, "radius", 0, (0, _validatorsJs.getNumberValidator)());

},{"../Factory.js":"cBseC","../Shape.js":"9jDGX","../Validators.js":"gkzNd","../Global.js":"asjHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2PVgS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _validatorsJs = require("../Validators.js");
var _globalJs = require("../Global.js");
class Ellipse extends (0, _shapeJs.Shape) {
    _sceneFunc(context) {
...
(0, _globalJs._registerNode)(Ellipse);
(0, _factoryJs.Factory).addComponentsGetterSetter(Ellipse, "radius", [
    "x",
    "y"
]);
(0, _factoryJs.Factory).addGetterSetter(Ellipse, "radiusX", 0, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Ellipse, "radiusY", 0, (0, _validatorsJs.getNumberValidator)());

},{"../Factory.js":"cBseC","../Shape.js":"9jDGX","../Validators.js":"gkzNd","../Global.js":"asjHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8V6x8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../Util.js":"a2B39","../Factory.js":"cBseC","../Shape.js":"9jDGX","../Validators.js":"gkzNd","../Global.js":"asjHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h6LDn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Label extends (0, _groupJs.Group) {
    constructor(config){
        super(config);
...
(0, _globalJs._registerNode)(Label);
class Tag extends (0, _shapeJs.Shape) {
    _sceneFunc(context) {
...
(0, _globalJs._registerNode)(Tag);
(0, _factoryJs.Factory).addGetterSetter(Tag, "pointerDirection", NONE);
(0, _factoryJs.Factory).addGetterSetter(Tag, "pointerWidth", 0, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Tag, "pointerHeight", 0, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Tag, "cornerRadius", 0, (0, _validatorsJs.getNumberOrArrayOfNumbersValidator)(4));

},{"../Factory.js":"cBseC","../Shape.js":"9jDGX","../Group.js":"X8qSb","../Validators.js":"gkzNd","../Global.js":"asjHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"27m53":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _globalJs = require("../Global.js");
var _validatorsJs = require("../Validators.js");
class Rect extends (0, _shapeJs.Shape) {
    _sceneFunc(context) {
...
(0, _globalJs._registerNode)(Rect);
(0, _factoryJs.Factory).addGetterSetter(Rect, "cornerRadius", 0, (0, _validatorsJs.getNumberOrArrayOfNumbersValidator)(4));

},{"../Factory.js":"cBseC","../Shape.js":"9jDGX","../Global.js":"asjHM","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hYPJG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _validatorsJs = require("../Validators.js");
var _globalJs = require("../Global.js");
class RegularPolygon extends (0, _shapeJs.Shape) {
    _sceneFunc(context) {
...
(0, _globalJs._registerNode)(RegularPolygon);
(0, _factoryJs.Factory).addGetterSetter(RegularPolygon, "radius", 0, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(RegularPolygon, "sides", 0, (0, _validatorsJs.getNumberValidator)());

},{"../Factory.js":"cBseC","../Shape.js":"9jDGX","../Validators.js":"gkzNd","../Global.js":"asjHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5Vsc3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _globalJs = require("../Global.js");
var PIx2 = Math.PI * 2;
class Ring extends (0, _shapeJs.Shape) {
    _sceneFunc(context) {
        context.beginPath();
...
(0, _globalJs._registerNode)(Ring);
(0, _factoryJs.Factory).addGetterSetter(Ring, "innerRadius", 0, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Ring, "outerRadius", 0, (0, _validatorsJs.getNumberValidator)());

},{"../Factory.js":"cBseC","../Shape.js":"9jDGX","../Validators.js":"gkzNd","../Global.js":"asjHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7ZPX9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _validatorsJs = require("../Validators.js");
var _globalJs = require("../Global.js");
class Sprite extends (0, _shapeJs.Shape) {
    constructor(config){
        super(config);
        this._updated = true;
        this.anim = new (0, _animationJs.Animation)(()=>{
...
(0, _globalJs._registerNode)(Sprite);
(0, _factoryJs.Factory).addGetterSetter(Sprite, "animation");
(0, _factoryJs.Factory).addGetterSetter(Sprite, "animations");
(0, _factoryJs.Factory).addGetterSetter(Sprite, "frameOffsets");
(0, _factoryJs.Factory).addGetterSetter(Sprite, "image");
(0, _factoryJs.Factory).addGetterSetter(Sprite, "frameIndex", 0, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Sprite, "frameRate", 17, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).backCompat(Sprite, {
    index: "frameIndex",
    getIndex: "getFrameIndex",
    setIndex: "setFrameIndex"
});

},{"../Factory.js":"cBseC","../Shape.js":"9jDGX","../Animation.js":"2pFne","../Validators.js":"gkzNd","../Global.js":"asjHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fLcjV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _validatorsJs = require("../Validators.js");
var _globalJs = require("../Global.js");
class Star extends (0, _shapeJs.Shape) {
    _sceneFunc(context) {
...
(0, _globalJs._registerNode)(Star);
(0, _factoryJs.Factory).addGetterSetter(Star, "numPoints", 5, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Star, "innerRadius", 0, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Star, "outerRadius", 0, (0, _validatorsJs.getNumberValidator)());

},{"../Factory.js":"cBseC","../Shape.js":"9jDGX","../Validators.js":"gkzNd","../Global.js":"asjHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i3gDI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function getDummyContext() {
    if (dummyContext) return dummyContext;
    dummyContext = (0, _utilJs.Util).createCanvasElement().getContext(CONTEXT_2D);
    return dummyContext;
}
function _fillFunc(context) {
...
class Text extends (0, _shapeJs.Shape) {
    constructor(config){
    ...
    setText(text) {
        var str = (0, _utilJs.Util)._isString(text) ? text : text === null || text === undefined ? "" : text + "";
    ...
    getTextHeight() {
        (0, _utilJs.Util).warn("text.getTextHeight() method is deprecated. Use text.height() - for full height and text.fontSize() - for one line height.");
...
(0, _globalJs._registerNode)(Text);
(0, _factoryJs.Factory).overWriteSetter(Text, "width", (0, _validatorsJs.getNumberOrAutoValidator)());
(0, _factoryJs.Factory).overWriteSetter(Text, "height", (0, _validatorsJs.getNumberOrAutoValidator)());
(0, _factoryJs.Factory).addGetterSetter(Text, "fontFamily", "Arial");
(0, _factoryJs.Factory).addGetterSetter(Text, "fontSize", 12, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Text, "fontStyle", NORMAL);
(0, _factoryJs.Factory).addGetterSetter(Text, "fontVariant", NORMAL);
(0, _factoryJs.Factory).addGetterSetter(Text, "padding", 0, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Text, "align", LEFT);
(0, _factoryJs.Factory).addGetterSetter(Text, "verticalAlign", TOP);
(0, _factoryJs.Factory).addGetterSetter(Text, "lineHeight", 1, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Text, "wrap", WORD);
(0, _factoryJs.Factory).addGetterSetter(Text, "ellipsis", false, (0, _validatorsJs.getBooleanValidator)());
(0, _factoryJs.Factory).addGetterSetter(Text, "letterSpacing", 0, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Text, "text", "", (0, _validatorsJs.getStringValidator)());
(0, _factoryJs.Factory).addGetterSetter(Text, "textDecoration", "");

},{"../Util.js":"a2B39","../Factory.js":"cBseC","../Shape.js":"9jDGX","../Validators.js":"gkzNd","../Global.js":"asjHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"elLOG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class TextPath extends (0, _shapeJs.Shape) {
    constructor(config){
        super(config);
        this.dummyCanvas = (0, _utilJs.Util).createCanvasElement();
        this.dataArray = [];
        this.dataArray = (0, _pathJs.Path).parsePathData(this.attrs.data);
        this.on("dataChange.konva", function() {
            this.dataArray = (0, _pathJs.Path).parsePathData(this.attrs.data);
            this._setTextData();
        });
    ...
    setText(text) {
        return (0, _textJs.Text).prototype.setText.call(this, text);
    }
    _getContextFont() {
        return (0, _textJs.Text).prototype._getContextFont.call(this);
    }
    _getTextSize(text) {
    ...
    _setTextData() {
        ...
        var charArr = (0, _textJs.stringToArray)(this.text());
        ...
        var findSegmentToFitCharacter = function(c) {
            ...
            while(Math.abs(glyphWidth - currLen) / glyphWidth > 0.01 && attempts < 20){
                ...
                if (Object.keys(pathCmd).length === 0 || p0 === undefined) return undefined;
                var needNewSegment = false;
                switch(pathCmd.command){
                    case "L":
                        if ((0, _pathJs.Path).getLineLength(p0.x, p0.y, pathCmd.points[0], pathCmd.points[1]) > glyphWidth) p1 = (0, _pathJs.Path).getPointOnLine(glyphWidth, p0.x, p0.y, pathCmd.points[0], pathCmd.points[1], p0.x, p0.y);
                    ...
                    case "A":
                        ...
                        p1 = (0, _pathJs.Path).getPointOnEllipticalArc(pathCmd.points[0], pathCmd.points[1], pathCmd.points[2], pathCmd.points[3], currentT, pathCmd.points[6]);
                        break;
                    case "C":
                        if (currentT === 0) {
                        ...
                        p1 = (0, _pathJs.Path).getPointOnCubicBezier(currentT, pathCmd.start.x, pathCmd.start.y, pathCmd.points[0], pathCmd.points[1], pathCmd.points[2], pathCmd.points[3], pathCmd.points[4], pathCmd.points[5]);
                        break;
                    case "Q":
                        ...
                        p1 = (0, _pathJs.Path).getPointOnQuadraticBezier(currentT, pathCmd.start.x, pathCmd.start.y, pathCmd.points[0], pathCmd.points[1], pathCmd.points[2], pathCmd.points[3]);
                        break;
                }
                if (p1 !== undefined) currLen = (0, _pathJs.Path).getLineLength(p0.x, p0.y, p1.x, p1.y);
                if (needNewSegment) {
        ...
        for(var i = 0; i < charArr.length; i++){
            ...
            if (p0 === undefined || p1 === undefined) break;
            var width = (0, _pathJs.Path).getLineLength(p0.x, p0.y, p1.x, p1.y);
            var kern = 0;
            if (kerningFunc) try {
            ...
            p1.x += kern;
            this.textWidth += kern;
            var midpoint = (0, _pathJs.Path).getPointOnLine(kern + width / 2.0, p0.x, p0.y, p1.x, p1.y);
    ...
    destroy() {
        (0, _utilJs.Util).releaseCanvas(this.dummyCanvas);
        return super.destroy();
    }
}
...
(0, _globalJs._registerNode)(TextPath);
(0, _factoryJs.Factory).addGetterSetter(TextPath, "data");
(0, _factoryJs.Factory).addGetterSetter(TextPath, "fontFamily", "Arial");
(0, _factoryJs.Factory).addGetterSetter(TextPath, "fontSize", 12, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(TextPath, "fontStyle", NORMAL);
(0, _factoryJs.Factory).addGetterSetter(TextPath, "align", "left");
(0, _factoryJs.Factory).addGetterSetter(TextPath, "letterSpacing", 0, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(TextPath, "textBaseline", "middle");
(0, _factoryJs.Factory).addGetterSetter(TextPath, "fontVariant", NORMAL);
(0, _factoryJs.Factory).addGetterSetter(TextPath, "text", EMPTY_STRING);
(0, _factoryJs.Factory).addGetterSetter(TextPath, "textDecoration", null);
(0, _factoryJs.Factory).addGetterSetter(TextPath, "kerningFunc", null);

},{"../Util.js":"a2B39","../Factory.js":"cBseC","../Shape.js":"9jDGX","./Path.js":"jCV6M","./Text.js":"i3gDI","../Validators.js":"gkzNd","../Global.js":"asjHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lKbeh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const TOUCH_DEVICE = "ontouchstart" in (0, _globalJs.Konva)._global;
function getCursor(anchorName, rad) {
    if (anchorName === "rotater") return "crosshair";
    rad += (0, _utilJs.Util).degToRad(ANGLES[anchorName] || 0);
    var angle = ((0, _utilJs.Util).radToDeg(rad) % 360 + 360) % 360;
    if ((0, _utilJs.Util)._inRange(angle, 337.5, 360) || (0, _utilJs.Util)._inRange(angle, 0, 22.5)) return "ns-resize";
    else if ((0, _utilJs.Util)._inRange(angle, 22.5, 67.5)) return "nesw-resize";
    else if ((0, _utilJs.Util)._inRange(angle, 67.5, 112.5)) return "ew-resize";
    else if ((0, _utilJs.Util)._inRange(angle, 112.5, 157.5)) return "nwse-resize";
    else if ((0, _utilJs.Util)._inRange(angle, 157.5, 202.5)) return "ns-resize";
    else if ((0, _utilJs.Util)._inRange(angle, 202.5, 247.5)) return "nesw-resize";
    else if ((0, _utilJs.Util)._inRange(angle, 247.5, 292.5)) return "ew-resize";
    else if ((0, _utilJs.Util)._inRange(angle, 292.5, 337.5)) return "nwse-resize";
    else {
        (0, _utilJs.Util).error("Transformer has unknown angle for cursor detection: " + angle);
        return "pointer";
    }
}
var ANCHORS_NAMES = [
...
function getSnap(snaps, newRotationRad, tol) {
    ...
    for(let i = 0; i < snaps.length; i++){
        const angle = (0, _globalJs.Konva).getAngle(snaps[i]);
...
class Transformer extends (0, _groupJs.Group) {
    constructor(config){
        super(config);
    ...
    setNode(node) {
        (0, _utilJs.Util).warn("tr.setNode(shape), tr.node(shape) and tr.attachTo(shape) methods are deprecated. Please use tr.nodes(nodesArray) instead.");
    ...
    __getNodeShape(node, rot = this.rotation(), relative) {
        ...
        const rotation = ((0, _globalJs.Konva).getAngle(node.getAbsoluteRotation()) + Math.PI * 2) % (Math.PI * 2);
        const box = {
        ...
        return rotateAroundPoint(box, -(0, _globalJs.Konva).getAngle(rot), {
            x: 0,
            y: 0
        });
    }
    __getNodeRect() {
        ...
        const tr = new (0, _utilJs.Transform)();
        tr.rotate(-(0, _globalJs.Konva).getAngle(this.rotation()));
        var minX, minY, maxX, maxY;
        ...
        return {
            ...
            width: maxX - minX,
            height: maxY - minY,
            rotation: (0, _globalJs.Konva).getAngle(this.rotation())
        };
    }
    getX() {
    ...
    _createAnchor(name) {
        ...
        anchor.on("mouseenter", ()=>{
            var rad = (0, _globalJs.Konva).getAngle(this.rotation());
    ...
    _createBack() {
        var back = new (0, _shapeJs.Shape)({
            ...
            sceneFunc (ctx) {
                ...
                if (tr.rotateEnabled()) ctx.lineTo(this.width() / 2, -tr.rotateAnchorOffset() * (0, _utilJs.Util)._sign(this.height()) - padding);
                ctx.fillStrokeShape(this);
            },
            hitFunc: (ctx, shape)=>{
    ...
    _handleMouseMove(e) {
        ...
        if (this._movingAnchorName === "rotater") {
            ...
            var oldRotation = (0, _globalJs.Konva).getAngle(this.rotation());
            const newRotation = oldRotation + delta;
            const tol = (0, _globalJs.Konva).getAngle(this.rotationSnapTolerance());
    ...
    _fitNodesInto(newAttrs, evt) {
        ...
        const minSize = 1;
        if ((0, _utilJs.Util)._inRange(newAttrs.width, -this.padding() * 2 - minSize, minSize)) {
            this.update();
            return;
        }
        if ((0, _utilJs.Util)._inRange(newAttrs.height, -this.padding() * 2 - minSize, minSize)) {
            this.update();
            return;
        }
        const allowNegativeScale = this.flipEnabled();
        var t = new (0, _utilJs.Transform)();
        t.rotate((0, _globalJs.Konva).getAngle(this.rotation()));
        if (this._movingAnchorName && newAttrs.width < 0 && this._movingAnchorName.indexOf("left") >= 0) {
            ...
            const offset1 = t.point({
                x: this.padding() * 2,
                y: 0
            });
            this._movingAnchorName = this._movingAnchorName.replace("right", "left");
            this._anchorDragOffset.x -= offset1.x;
            this._anchorDragOffset.y -= offset1.y;
            newAttrs.width += this.padding() * 2;
            if (!allowNegativeScale) {
                this.update();
                return;
        ...
        if (this._movingAnchorName && newAttrs.height < 0 && this._movingAnchorName.indexOf("top") >= 0) {
            ...
            const offset3 = t.point({
                x: 0,
                y: this.padding() * 2
            });
            this._movingAnchorName = this._movingAnchorName.replace("bottom", "top");
            this._anchorDragOffset.x -= offset3.x;
            this._anchorDragOffset.y -= offset3.y;
            newAttrs.height += this.padding() * 2;
            if (!allowNegativeScale) {
                this.update();
                return;
        ...
        if (this.boundBoxFunc()) {
            ...
            else (0, _utilJs.Util).warn("boundBoxFunc returned falsy. You should return new bound rect from it!");
        }
        const baseSize = 10000000;
        const oldTr = new (0, _utilJs.Transform)();
        oldTr.translate(oldAttrs.x, oldAttrs.y);
        oldTr.rotate(oldAttrs.rotation);
        oldTr.scale(oldAttrs.width / baseSize, oldAttrs.height / baseSize);
        const newTr = new (0, _utilJs.Transform)();
        ...
        this._nodes.forEach((node)=>{
            ...
            const newLocalTransform = new (0, _utilJs.Transform)();
        ...
        this.rotation((0, _utilJs.Util)._getRotation(newAttrs.rotation));
        this._resetTransformCache();
        this.update();
    ...
    update() {
        var _a;
        var attrs = this._getNodeRect();
        this.rotation((0, _utilJs.Util)._getRotation(attrs.rotation));
        var width = attrs.width;
        var height = attrs.height;
        ...
        this._batchChangeChild(".rotater", {
            x: width / 2,
            y: -this.rotateAnchorOffset() * (0, _utilJs.Util)._sign(height) - padding,
    ...
    destroy() {
        ...
        (0, _groupJs.Group).prototype.destroy.call(this);
        this.detach();
        this._removeEvents();
        return this;
    }
    toObject() {
        return (0, _nodeJs.Node).prototype.toObject.call(this);
    }
    getClientRect() {
...
function validateAnchors(val) {
    if (!(val instanceof Array)) (0, _utilJs.Util).warn("enabledAnchors value should be an array");
    if (val instanceof Array) val.forEach(function(name) {
        if (ANCHORS_NAMES.indexOf(name) === -1) (0, _utilJs.Util).warn("Unknown anchor name: " + name + ". Available names are: " + ANCHORS_NAMES.join(", "));
    });
    return val || [];
}
Transformer.prototype.className = "Transformer";
(0, _globalJs._registerNode)(Transformer);
(0, _factoryJs.Factory).addGetterSetter(Transformer, "enabledAnchors", ANCHORS_NAMES, validateAnchors);
(0, _factoryJs.Factory).addGetterSetter(Transformer, "flipEnabled", true, (0, _validatorsJs.getBooleanValidator)());
(0, _factoryJs.Factory).addGetterSetter(Transformer, "resizeEnabled", true);
(0, _factoryJs.Factory).addGetterSetter(Transformer, "anchorSize", 10, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Transformer, "rotateEnabled", true);
(0, _factoryJs.Factory).addGetterSetter(Transformer, "rotationSnaps", []);
(0, _factoryJs.Factory).addGetterSetter(Transformer, "rotateAnchorOffset", 50, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Transformer, "rotationSnapTolerance", 5, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Transformer, "borderEnabled", true);
(0, _factoryJs.Factory).addGetterSetter(Transformer, "anchorStroke", "rgb(0, 161, 255)");
(0, _factoryJs.Factory).addGetterSetter(Transformer, "anchorStrokeWidth", 1, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Transformer, "anchorFill", "white");
(0, _factoryJs.Factory).addGetterSetter(Transformer, "anchorCornerRadius", 0, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Transformer, "borderStroke", "rgb(0, 161, 255)");
(0, _factoryJs.Factory).addGetterSetter(Transformer, "borderStrokeWidth", 1, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Transformer, "borderDash");
(0, _factoryJs.Factory).addGetterSetter(Transformer, "keepRatio", true);
(0, _factoryJs.Factory).addGetterSetter(Transformer, "centeredScaling", false);
(0, _factoryJs.Factory).addGetterSetter(Transformer, "ignoreStroke", false);
(0, _factoryJs.Factory).addGetterSetter(Transformer, "padding", 0, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Transformer, "node");
(0, _factoryJs.Factory).addGetterSetter(Transformer, "nodes");
(0, _factoryJs.Factory).addGetterSetter(Transformer, "boundBoxFunc");
(0, _factoryJs.Factory).addGetterSetter(Transformer, "anchorDragBoundFunc");
(0, _factoryJs.Factory).addGetterSetter(Transformer, "shouldOverdrawWholeArea", false);
(0, _factoryJs.Factory).addGetterSetter(Transformer, "useSingleNodeRotation", true);
(0, _factoryJs.Factory).backCompat(Transformer, {
    lineEnabled: "borderEnabled",
    rotateHandlerOffset: "rotateAnchorOffset",
    enabledHandlers: "enabledAnchors"
});

},{"../Util.js":"a2B39","../Factory.js":"cBseC","../Node.js":"bfHol","../Shape.js":"9jDGX","./Rect.js":"27m53","../Group.js":"X8qSb","../Global.js":"asjHM","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"73XBE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _globalJs = require("../Global.js");
var _validatorsJs = require("../Validators.js");
class Wedge extends (0, _shapeJs.Shape) {
    _sceneFunc(context) {
        context.beginPath();
        context.arc(0, 0, this.radius(), 0, (0, _globalJs.Konva).getAngle(this.angle()), this.clockwise());
        context.lineTo(0, 0);
        context.closePath();
        context.fillStrokeShape(this);
    }
...
(0, _globalJs._registerNode)(Wedge);
(0, _factoryJs.Factory).addGetterSetter(Wedge, "radius", 0, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Wedge, "angle", 0, (0, _validatorsJs.getNumberValidator)());
(0, _factoryJs.Factory).addGetterSetter(Wedge, "clockwise", false);
(0, _factoryJs.Factory).backCompat(Wedge, {
    angleDeg: "angle",
    getAngleDeg: "getAngle",
    setAngleDeg: "setAngle"
});

},{"../Factory.js":"cBseC","../Shape.js":"9jDGX","../Global.js":"asjHM","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9W72y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "blurRadius", 0, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);

},{"../Factory.js":"cBseC","../Node.js":"bfHol","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lAvpJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "brightness", 0, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);

},{"../Factory.js":"cBseC","../Node.js":"bfHol","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8RNiy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "contrast", 0, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);

},{"../Factory.js":"cBseC","../Node.js":"bfHol","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6vWw3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const Emboss = function(imageData) {
    ...
    switch(direction){
        ...
        case "left":
            ...
            break;
        default:
            (0, _utilJs.Util).error("Unknown emboss direction: " + direction);
    }
    do {
        var offsetY = (y - 1) * w4;
        var otherY = dirY;
...
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "embossStrength", 0.5, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "embossWhiteLevel", 0.5, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "embossDirection", "top-left", null, (0, _factoryJs.Factory).afterSetFilter);
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "embossBlend", false, null, (0, _factoryJs.Factory).afterSetFilter);

},{"../Factory.js":"cBseC","../Node.js":"bfHol","../Util.js":"a2B39","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7UWph":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "enhance", 0, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);

},{"../Factory.js":"cBseC","../Node.js":"bfHol","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bjkFS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9ygkl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _nodeJs = require("../Node.js");
var _validatorsJs = require("../Validators.js");
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "hue", 0, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "saturation", 0, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "luminance", 0, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);
...
},{"../Factory.js":"cBseC","../Node.js":"bfHol","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6AhsM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "hue", 0, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "saturation", 0, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "value", 0, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);

},{"../Factory.js":"cBseC","../Node.js":"bfHol","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4xcg6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4en15":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const Kaleidoscope = function(imageData) {
    ...
    if (power < 1) return;
    var tempCanvas = (0, _utilJs.Util).createCanvasElement();
    tempCanvas.width = xSize;
    tempCanvas.height = ySize;
    var scratchData = tempCanvas.getContext("2d").getImageData(0, 0, xSize, ySize);
    (0, _utilJs.Util).releaseCanvas(tempCanvas);
...
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "kaleidoscopePower", 2, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "kaleidoscopeAngle", 0, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);

},{"../Factory.js":"cBseC","../Node.js":"bfHol","../Util.js":"a2B39","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"54Bc9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "threshold", 0, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);

},{"../Factory.js":"cBseC","../Node.js":"bfHol","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"a6ed4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "noise", 0.2, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);

},{"../Factory.js":"cBseC","../Node.js":"bfHol","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4rWev":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const Pixelate = function(imageData) {
    ...
    if (pixelSize <= 0) {
        (0, _utilJs.Util).error("pixelSize value can not be <= 0");
        return;
    }
...
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "pixelSize", 8, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);

},{"../Factory.js":"cBseC","../Util.js":"a2B39","../Node.js":"bfHol","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kjeD1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "levels", 0.5, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);

},{"../Factory.js":"cBseC","../Node.js":"bfHol","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"w7wf7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "red", 0, function(val) {
    this._filterUpToDate = false;
    if (val > 255) return 255;
    else if (val < 0) return 0;
    else return Math.round(val);
});
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "green", 0, function(val) {
    this._filterUpToDate = false;
    if (val > 255) return 255;
    else if (val < 0) return 0;
    else return Math.round(val);
});
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "blue", 0, (0, _validatorsJs.RGBComponent), (0, _factoryJs.Factory).afterSetFilter);

},{"../Factory.js":"cBseC","../Node.js":"bfHol","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cxuQv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "blue", 0, (0, _validatorsJs.RGBComponent), (0, _factoryJs.Factory).afterSetFilter);
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "alpha", 1, function(val) {
    this._filterUpToDate = false;
    if (val > 1) return 1;
    else if (val < 0) return 0;
    else return val;
...
},{"../Factory.js":"cBseC","../Node.js":"bfHol","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dNJFy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"atrXz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9jS1t":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
(0, _factoryJs.Factory).addGetterSetter((0, _nodeJs.Node), "threshold", 0.5, (0, _validatorsJs.getNumberValidator)(), (0, _factoryJs.Factory).afterSetFilter);

},{"../Factory.js":"cBseC","../Node.js":"bfHol","../Validators.js":"gkzNd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["awEvQ","bB7Pu"], "bB7Pu", "parcelRequire01ac")
